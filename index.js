...
async function handleButtonClick() {
  ...
  strMisson = document.getElementById("mission").value.trim();
...
function Correct(image_clicked) {
  ...
  countWin = countWin + 2;
  if (countWin == strMisson)
  {
    sleep(2000);
    if (alert("Congrats ! you have finished the game in : " + minutes + " minutes and " + seconds + " seconds,\n Click ok to play again" )) 
    {
    }
